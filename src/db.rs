...
pub trait TaskStore: Send + Sync {
    ...
    fn update_status_if(&self, id: i64, new_status: TaskStatus, expected: TaskStatus) -> Result<bool>;
...
mod tests {
    ...
    fn update_status_if_nonexistent() {
        let db = in_memory_db();
        let updated = db.update_status_if(9999, TaskStatus::Review, TaskStatus::Running).unwrap();
